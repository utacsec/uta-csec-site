jQuery(function () {
	...
	// MAP OPTIONS
	const myLatlng = new google.maps.LatLng(-33.867259, 151.207051);
	const mapOptions = {
		zoom: 14,
		center: myLatlng,
		scrollwheel: false,
	...
	// LOAD MAP
	const map = new google.maps.Map(document.getElementById('meetup-map'), mapOptions);
	...
	const infowindow = new google.maps.InfoWindow({
		content: '500 UTA Blvd, Arlington, TX 76018',
	});
